...
def gem_update():
	...
	subprocess.check_call("gem update `gem list | cut -d ' ' -f 1` --no-rdoc --no-ri", shell=True)
...
def main():
	...
	parser = argparse.ArgumentParser(description='BackBox Update script helps you to keep updated your system and tools', version='%(prog)s v.0.4 - Powered by Raffaele Forte')
